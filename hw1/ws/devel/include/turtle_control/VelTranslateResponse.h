...
struct VelTranslateResponse_
{
  ...
  VelTranslateResponse_(const ContainerAllocator& _alloc)
    : TurtleVelReturn(_alloc)  {
  (void)_alloc;
    }



   typedef  ::turtle_control::TurtleVel_<ContainerAllocator>  _TurtleVelReturn_type;
  _TurtleVelReturn_type TurtleVelReturn;
...
struct MD5Sum< ::turtle_control::VelTranslateResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x1695ba1358130d54ULL;
  static const uint64_t static_value2 = 0x5c755713e7ca52b4ULL;
};
...
struct Definition< ::turtle_control::VelTranslateResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "TurtleVel TurtleVelReturn\n"
"\n"
"\n"
"================================================================================\n"
...
struct Printer< ::turtle_control::VelTranslateResponse_<ContainerAllocator> >
{
  ...
  {
    s << indent << "TurtleVelReturn: ";
    s << std::endl;
    Printer< ::turtle_control::TurtleVel_<ContainerAllocator> >::stream(s, indent + "  ", v.TurtleVelReturn);
  }
};
