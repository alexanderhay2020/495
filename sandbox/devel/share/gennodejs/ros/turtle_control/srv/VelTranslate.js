...
class VelTranslateResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.turtle_vel = null;
    }
    else {
      if (initObj.hasOwnProperty('turtle_vel')) {
        this.turtle_vel = initObj.turtle_vel
      }
      else {
        this.turtle_vel = new TurtleVel();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [turtle_vel]
    bufferOffset = TurtleVel.serialize(obj.turtle_vel, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [turtle_vel]
    data.turtle_vel = TurtleVel.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.turtle_vel !== undefined) {
      resolved.turtle_vel = TurtleVel.Resolve(msg.turtle_vel)
    }
    else {
      resolved.turtle_vel = new TurtleVel()
    }
...
module.exports = {
  ...
  md5sum() { return 'cf2a08b505b561a876017bf49e86a2f9'; },
